...
class LiuYan extends React.Component{
    ...
    loadLiuYan(){
        ...
        let url="http://localhost:8888/liuyan/findAll";
...
//批量删除(出错)
    batchDelete(){
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/liuyan/batchDelete";
               $.ajax({
                   url,
                   method:"POST",
     ...
     toDelete=(id)=> {
        ...
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/liuyan/deleteById?id="+id;
    ...
    //点击模态框的确认按钮
      handleOk = e => {
        ...
        this.form.validateFields((err,values)=>{
            if(!err){
                let url="http://localhost:8888/liuyan/saveOrUpdate";
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    <LiuYanForm 
                    initData={this.state.liuyan} ref={this.LiuYanFormRefs} />
                 </Modal>
            </div>
        )
    }
