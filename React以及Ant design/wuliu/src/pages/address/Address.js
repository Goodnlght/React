...
class Address extends React.Component{
    ...
    loadAddress(){
        ...
        let url="http://localhost:8888/address/findAll";
...
//批量删除(出错)
    batchDelete(){
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/address/batchDelete";
               $.ajax({
                   url,
                   method:"POST",
     ...
     toDelete=(id)=> {
        ...
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/address/deleteById?id="+id;
    ...
    //点击模态框的确认按钮
      handleOk = e => {
        ...
        this.form.validateFields((err,values)=>{
            if(!err){
                let url="http://localhost:8888/address/saveOrUpdate";
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    <AddressForm 
                    initData={this.state.address} ref={this.AddressFormRefs} />
                 </Modal>
            </div>
        )
    }
