...
class Company extends React.Component{
    ...
    loadCompany(){
        ...
        let url="http://localhost:8888/company/findAll";
...
//批量删除(出错)
    batchDelete(){
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/company/batchDelete";
               $.ajax({
                   url,
                   method:"POST",
     ...
     toDelete=(id)=> {
        ...
        Modal.confirm({
            ...
            onOk:()=>{
                //编写代码进行删除
               let url = "http://localhost:8888/company/deleteById?id="+id;
    ...
    //点击模态框的确认按钮
      handleOk = e => {
        ...
        this.form.validateFields((err,values)=>{
            if(!err){
                let url="http://localhost:8888/company/saveOrUpdate";
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    <CompanyForm 
                    initData={this.state.company} ref={this.CompanyFormRefs} />
                 </Modal>
            </div>
        )
    }
