...
class OrderForm extends React.Component {
  ...
  render(){
    ...
    return (
      ...
      <Form.Item label="产品信息id">
          {getFieldDecorator('productMessageId', {
            rules: [{ required: true, message: 'Please input your productMessageId !' }],
          })(
            <Input placeholder="productMessageId" />,
          )}
       </Form.Item>
